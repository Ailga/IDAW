    ...
    <body>
        <h1>Mes compétences</h1>
            ...
            <h2>Compétences générales</h2>
                <ul>
                    <li>Organisation d'évènements, à l'occasion d'anniversaires ou de repas de famille mais aussi pour organiser des conférences par exemple</li>
